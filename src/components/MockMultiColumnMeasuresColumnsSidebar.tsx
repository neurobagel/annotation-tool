...
import { Card, CardContent, CardHeader, Typography, TextField, InputAdornment, Button, Checkbox, FormControlLabel, Switch } from '@mui/material';
...
export default function MockMultiColumnMeasuresColumnsSidebar({ allColumns, mappedColumnIds }: MockSidebarProps) {
                    ...
                    <div className="flex flex-col gap-2">
                        <div className="flex justify-between items-start">
                            ...
                            <FormControlLabel
                                ...
                                label={<Typography variant="caption" className="text-gray-600">Show Assigned</Typography>}
                        ...
                        {(searchTerm || selectedColumnIds.length > 0) && (
                            <div className="flex justify-between items-center text-xs mt-1">
                                ...
                                <div className="flex gap-2">
                                    <Button size="small" onClick={handleSelectAll} sx={{ fontSize: '0.7rem', minWidth: 'auto', p: 0.5 }}>
                                        Select All
                                    </Button>
                                    <Button size="small" onClick={handleClearSelection} color="warning" sx={{ fontSize: '0.7rem', minWidth: 'auto', p: 0.5 }}>
                                        Clear
                                    </Button>
                                </div>
                            </div>
